...
export class RegisterComponent implements OnInit {
  ...
  warning:string;
  teams = ["Albania", "Algieria", "Anglia", "Angola", "ArabiaSaudyjska", "Argentyna", "Australia", "Austria", "Azerbejdżan", "Bahrajn", "Belgia", "Benin", "Bialorus", "Boliwia", "BośniaIHercegowina", "Brazylia", "Bułgaria", "Chile", "Chiny", "Chorwacja", "Cypr", "Czechy", "Dania", "Egipt", "Ekwador", "Estonia", "Finlandia", "Francja", "Gabon", "Ghana", "Grecja", "Hiszpania", "Holandia", "Honduras", "Irlandia", "Islandia", "Izrael", "Jamajka", "Japonia", "Kamerun", "Kazahstan", "Kolumbia", "Kongo", "Kuba", "Liechtenstein", "Luxemburg", "Litwa", "Łotwa", "MacedoniaPółnocna", "Mali", "Malta", "Maroko", "Meksyk", "Niemcy", "Nigeria", "Norwegia", "Panama", "Paragwaj", "Peru", "Polska", "PołudniowaAfryka", "Portugalia", "Rosja", "Rumunia", "Senegal", "Serbia", "Słowacja", "Słowenia", "Syria", "Szwajcaria", "Szwecja", "Togo", "Tunezja", "Turcja", "Ukraina", "Urugwaj", "USA", "Węgry", "Wenezuala", "Włochy","WybrzeżeKościSłoniowej"];
