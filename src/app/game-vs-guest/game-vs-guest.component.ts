...
@Component({
  selector: 'app-game-vs-guest',
  templateUrl: './game-vs-guest.component.html',
  styleUrls: ['./game-vs-guest.component.scss']
})
export class GameVsGuestComponent implements OnInit {
