...
@Component({
  selector: 'app-game-guest',
  templateUrl: './game-guest.component.html',
  styleUrls: ['./game-guest.component.scss']
})
export class GameGuestComponent implements OnInit {
...
if(this.rounds[0] == "deffend"){
  ...
  this.httpService.updatePlayer(rival).subscribe(rival => {
    this.router.navigateByUrl('/gameOverGuest');
  })
})
